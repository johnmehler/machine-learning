...
y_update = zeros(num_labels, m);
for i=1:m,
  y_update(y(i),i)=1;
end

J = (1/m) * sum(sum((-y_update) .* log(h_theta) - (1-y_update) .* log(1-h_theta)));

% Regularization - Not sure why my earlier answer was wrong...
...
for t=1:m
  ...
  % Work backwards for delta
  delta_3 = a3 - y_update(:,t); % (10*1)
